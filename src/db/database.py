...
DB_USER = os.getenv("POSTGRES_USER", "router")
DB_PASSWORD = os.getenv("POSTGRES_PASSWORD", "localsecret")
...
print(
    f"Connecting to database at: postgresql+asyncpg://{DB_USER}:******@{DB_HOST}:{DB_PORT}/{DB_NAME}"
)
